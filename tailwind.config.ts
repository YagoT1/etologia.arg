...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        background: '#F7F4EE', foreground: '#232323', surface: '#FFFCF8', border: '#D4CCBE',
        primary: { DEFAULT: '#3E4A42', foreground: '#FCFBF8', soft: '#A8B5A2' },
        secondary: { DEFAULT: '#E6E0D6', foreground: '#232323' },
        accent: { DEFAULT: '#A8B5A2', foreground: '#232323' },
        muted: { DEFAULT: '#EFE9E0', foreground: '#3B453E' },
      ...
      boxShadow: { soft: '0 2px 12px rgb(35 35 35 / 0.06)', card: '0 14px 40px rgb(35 35 35 / 0.08)', focus: '0 0 0 3px rgb(247 244 238 / 1), 0 0 0 5px rgb(62 74 66 / 1)' },
