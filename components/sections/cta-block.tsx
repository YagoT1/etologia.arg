  ...
  return (
    <section className="rounded-xl bg-primary px-6 py-10 text-primary-foreground sm:px-8 sm:py-12">
      <div className="mx-auto max-w-[56ch] text-center">
        ...
        <h3 className="mt-3 type-h2">Cuando hay criterio profesional, la convivencia mejora.</h3>
        <p className="mt-4 type-body-lg text-primary-foreground/80">Si querés ordenar el proceso con una guía clara y humana, podemos empezar hoy.</p>
